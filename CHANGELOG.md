...
* **refactor:** remove debug comment ([edaffdf](https://github.com/watilde/dep/commit/edaffdf))
...
* **dep:** use rimraf ([116bdcc](https://github.com/watilde/dep/commit/116bdcc))
* **ux:** display log about what dep is doing ([f1ec072](https://github.com/watilde/dep/commit/f1ec072))
